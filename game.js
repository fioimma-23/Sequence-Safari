...
const drawGameOverScreen = () => {
  if (collision) {
    colorRectangle(0, 0, 480, canvas.height, 'rgba(23, 38, 1, 0.9)');
    canvasContext.font = '50px serif';
    canvasContext.fillStyle = '#85A60F';
    canvasContext.fillText('Game Over', 60, 150);
    canvasContext.fillText(`Score: ${score}`, 100, 225);

    canvasContext.font = '25px serif';
    canvasContext.fillText('Press Spacebar to play again', 40, 300);
  }
};
